...
| `TigreGotico/audiosronnx-unipase` | `encoder_adapter.onnx`, `vocoder.onnx`, `encoder_adapter.fp16.onnx`, `vocoder.fp16.onnx` |
...
| unipase | correlation 0.99999988 (fp16 variant: 0.99993) |
